...
-- FORCE ROW LEVEL SECURITY : s'applique aussi au propriétaire de la table (neondb_owner)
-- Sans FORCE, le owner bypass RLS → toutes les données visibles cross-tenant
...
ALTER TABLE intervention_parts_used FORCE ROW LEVEL SECURITY;
ALTER TABLE stock_transfer_requests ENABLE ROW LEVEL SECURITY;
ALTER TABLE stock_transfer_requests FORCE ROW LEVEL SECURITY;
...
ALTER TABLE intervention_planned_materials FORCE ROW LEVEL SECURITY;
...
ALTER TABLE machine_attachments FORCE ROW LEVEL SECURITY;
...
ALTER TABLE machine_counters FORCE ROW LEVEL SECURITY;
...
ALTER TABLE machine_counter_readings FORCE ROW LEVEL SECURITY;
...
ALTER TABLE machine_components FORCE ROW LEVEL SECURITY;
...
ALTER TABLE intervention_attachments FORCE ROW LEVEL SECURITY;
...
ALTER TABLE intervention_time_entries FORCE ROW LEVEL SECURITY;
...
ALTER TABLE intervention_checklists FORCE ROW LEVEL SECURITY;
